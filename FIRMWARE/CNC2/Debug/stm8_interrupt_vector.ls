 ...
 109  003d 00            	dc.b	page(_iTim2_overflow)
 110  003e 0000          	dc.w	_iTim2_overflow
 ...
 125  004d 00            	dc.b	page(_UART_TX_IRQHandler)
 126  004e 0000          	dc.w	_UART_TX_IRQHandler
 127  0050 82            	dc.b	130
 129  0051 00            	dc.b	page(_UART_RX_IRQHandler)
 130  0052 0000          	dc.w	_UART_RX_IRQHandler
 ...
 137  0059 00            	dc.b	page(_UART_TX_IRQHandler)
 138  005a 0000          	dc.w	_UART_TX_IRQHandler
 139  005c 82            	dc.b	130
 141  005d 00            	dc.b	page(_UART_RX_IRQHandler)
 142  005e 0000          	dc.w	_UART_RX_IRQHandler
 ...
 225                     	xdef	__vectab
 226                     	xref	_UART_RX_IRQHandler
 227                     	xref	_UART_TX_IRQHandler
 228                     	xref	_iTim2_overflow
 229                     	xref	__stext
