...
#define EVT_INTERRUPT_I2C 19

#define EVT_INTERRUPT_UART2_TX 20
#define EVT_INTERRUPT_UART2_RX 21
 
#define EVT_INTERRUPT_TIM4_UO 23
#define EVT_INTERRUPT_EEPROM 24
