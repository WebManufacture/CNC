...
GerberCompiler.prototype = {
	compile: function (text, callback) {
		var code = [];
		var xRatio = CncUI.Settings.gerberXRatio ? parseFloat(CncUI.Settings.gerberXRatio) : 1;
		var yRatio = CncUI.Settings.gerberYRatio ? parseFloat(CncUI.Settings.gerberYRatio) : 1;
		this.x = lx;
		this.y = ly;
		this.z = lz;
