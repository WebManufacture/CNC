...
nut_diameter = 14.2;
nut_height = 7;		// angle between nuts, standard = 90
...
//	translate ([0,0, pulley_b_ht + pulley_t_ht + retainer_ht ]) rotate ([0,180,0])
	...
	difference()
	 {	 
	    ...
	    top = pulley_b_ht + pulley_t_ht + retainer_ht + idler_ht + 2;
		translate([0,0,top-nut_height-nut_from_top])cylinder(h = nut_height, d=nut_diameter, $fa = 60, center = true);
        translate([0,0,top-nut_height])cylinder(d=nut_inner_diameter, h=nut_height + nut_from_top, center=true);
        
        //hole for motor shaft        
		translate([0,0,-1])cylinder(r=motor_shaft/2,h=top,$fn=motor_shaft*4);
	 }
